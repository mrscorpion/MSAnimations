...
#import "MsTouchController.h"
#import <QuartzCore/CoreAnimation.h>

// ===============================================================================================================
@implementation MsTouchController
// ===============================================================================================================
...
- (void) viewDidLoad
{
	...
	ring.contents = (id) [[UIImage imageNamed:@"MsTriangle"] CGImage];
	...
	circle.contents = (id) [[UIImage imageNamed:@"MsRing"] CGImage];
	...
	star.contents = (id) [[UIImage imageNamed:@"MsStarOutline"] CGImage];
